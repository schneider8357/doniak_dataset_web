...
class Oeuvre(models.Model):
    ...
    oeuvre_titre = models.CharField(max_length=255, null=False, blank=False)
    oeuvre_titre_doniak = models.CharField(max_length=255, null=False, blank=False)
    collection_serie = models.CharField(max_length=255, null=False, blank=False)
    date_diff = models.DateField(null=False)
    chaine = models.CharField(max_length=255, blank=False, null=False)
    note = models.CharField(max_length=255, blank=True, default='')
    episodes_nbr = models.CharField(max_length=255, blank=True, default='')
    duree = models.CharField(max_length=255, blank=True, default='')
    genre_oeuvre = models.CharField(max_length=255, blank=True, default='')
    num_saisons = models.CharField(max_length=255, blank=True, default='')
